...
namespace HOLMS.Platform.Client {
    public class MockApplicationClient : IApplicationClient {
        ...
        public OperationsReportingSvc.OperationsReportingSvcClient OperationsReportingSvc { get; }
        ...
        public GroupBookingSearchSvc.GroupBookingSearchSvcClient GroupBookingSearchSvc {
            get {
                throw new NotImplementedException();
            }
        }
