...
namespace HOLMS.Types.Operations.Rooms {
    ...
    static RoomReflection() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            ...
            "ZmlnL3Jvb21fc3RhdHVzLnByb3RvIqMHCgRSb29tEj4KCWVudGl0eV9pZBgB",
            ...
            "ASgLMiYuaG9sbXMudHlwZXMudGVuYW5jeV9jb25maWcuUm9vbVN0YXR1cxIz",
            "Cg9tYXJrZWRfZGlydHlfYXQYEiABKAsyGi5nb29nbGUucHJvdG9idWYuVGlt",
            "ZXN0YW1wEhUKDWlzX2xlZnRfZGlydHkYEyABKAgSGAoQcm9vbV90eXBlX2Fj",
            "dGl2ZRgUIAEoCEIfqgIcSE9MTVMuVHlwZXMuT3BlcmF0aW9ucy5Sb29tc2IG",
            "cHJvdG8z"));
  ...
  public sealed partial class Room : pb::IMessage<Room> {
    ...
    public Room(Room other) : this() {
      ...
      MarkedDirtyAt = other.markedDirtyAt_ != null ? other.MarkedDirtyAt.Clone() : null;
      isLeftDirty_ = other.isLeftDirty_;
      roomTypeActive_ = other.roomTypeActive_;
    }
    ...
    /// <summary>Field number for the "marked_dirty_at" field.</summary>
    public const int MarkedDirtyAtFieldNumber = 18;
    private global::Google.Protobuf.WellKnownTypes.Timestamp markedDirtyAt_;
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public global::Google.Protobuf.WellKnownTypes.Timestamp MarkedDirtyAt {
      get { return markedDirtyAt_; }
      set {
        markedDirtyAt_ = value;
      }
    }

    /// <summary>Field number for the "is_left_dirty" field.</summary>
    public const int IsLeftDirtyFieldNumber = 19;
    private bool isLeftDirty_;
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public bool IsLeftDirty {
      get { return isLeftDirty_; }
      set {
        isLeftDirty_ = value;
      }
    }

    /// <summary>Field number for the "room_type_active" field.</summary>
    public const int RoomTypeActiveFieldNumber = 20;
    private bool roomTypeActive_;
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public bool RoomTypeActive {
      get { return roomTypeActive_; }
      set {
        roomTypeActive_ = value;
      }
    }
    ...
    public bool Equals(Room other) {
      ...
      if (!object.Equals(MarkedDirtyAt, other.MarkedDirtyAt)) return false;
      if (IsLeftDirty != other.IsLeftDirty) return false;
      if (RoomTypeActive != other.RoomTypeActive) return false;
      return true;
    }
    ...
    public override int GetHashCode() {
      ...
      if (markedDirtyAt_ != null) hash ^= MarkedDirtyAt.GetHashCode();
      if (IsLeftDirty != false) hash ^= IsLeftDirty.GetHashCode();
      if (RoomTypeActive != false) hash ^= RoomTypeActive.GetHashCode();
      return hash;
    }
    ...
    public void WriteTo(pb::CodedOutputStream output) {
      ...
      if (markedDirtyAt_ != null) {
        ...
        output.WriteMessage(MarkedDirtyAt);
      }
      if (IsLeftDirty != false) {
        output.WriteRawTag(152, 1);
        output.WriteBool(IsLeftDirty);
      }
      if (RoomTypeActive != false) {
        output.WriteRawTag(160, 1);
        output.WriteBool(RoomTypeActive);
      }
    }
    ...
    public int CalculateSize() {
      ...
      if (markedDirtyAt_ != null) {
        size += 2 + pb::CodedOutputStream.ComputeMessageSize(MarkedDirtyAt);
      }
      if (IsLeftDirty != false) {
        size += 2 + 1;
      }
    ...
    public void MergeFrom(Room other) {
      ...
      if (other.RoomTypeActive != false) {
        RoomTypeActive = other.RoomTypeActive;
      }
    }
