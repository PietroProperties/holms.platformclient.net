...
SET PROTOC=packages\Grpc.Tools.1.0.0\tools\windows_x64\protoc.exe
SET GRPCC=packages\Grpc.Tools.1.0.0\tools\windows_x64\grpc_csharp_plugin.exe
SET OUT_DIR=%~dp0\HOLMS.Types\out
