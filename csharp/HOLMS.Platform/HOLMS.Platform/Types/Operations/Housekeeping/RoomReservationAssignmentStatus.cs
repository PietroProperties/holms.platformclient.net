    ...
    public static class RoomReservationAssignmentStatusExtensions {
        public static string ToEnglish(this RoomReservationAssignmentStatus rras) {
            switch (rras) {
                ...
                case RoomReservationAssignmentStatus.LeavingWithOutOfOrder:
                    return "Departure/OOO";
                ...
                case RoomReservationAssignmentStatus.RoomReservationAssignmentOutOfOrder:
                    return "Out of order";
                case RoomReservationAssignmentStatus.VacantLeavingWithIncoming:
                    return "Vacant/ Arrival";
                case RoomReservationAssignmentStatus.VacantLeavingWithOutOfOrder:
                    return "Vacant/ OOO";
